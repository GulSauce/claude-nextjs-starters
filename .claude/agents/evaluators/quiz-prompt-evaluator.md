...
- 17-20점: 정답+해설+오답 품질 기준+IWF 방지 모두 포함
- 13-16점: 정답+해설 포함, 오답 품질 기준 일부 부족
- 8-12점: 기본 정답/해설만 요구
...
- **고정값 존중**: 원본에서 placeholder 없이 고정값으로 설계된 요소(예: 오답 3유형 균등 배치, 4단계 해설 구조, 하/중/상 균등 배분 등)는 그대로 고정값을 유지하세요.
